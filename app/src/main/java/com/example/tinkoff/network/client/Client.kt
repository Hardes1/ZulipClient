...
import com.example.tinkoff.network.interceptors.AuthInterceptor
import com.example.tinkoff.network.services.MessagesService
import com.example.tinkoff.network.services.StreamsService
import com.example.tinkoff.network.services.UsersService
...
private val client = OkHttpClient().newBuilder().apply {
    addInterceptor(AuthInterceptor()).addInterceptor(HttpLoggingInterceptor {
        Timber.d(it)
    }.apply {
